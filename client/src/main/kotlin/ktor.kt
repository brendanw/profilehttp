...
fun main(args: Array<String>) {
  runBlocking {
    println("====== ktor numThreads=8 =======\n\n")
    runSuite(8)

    println("====== ktor numThreads=1 =======\n\n")
    runSuite(1)
  }
}

lateinit var reusableClient: HttpClient

private suspend fun runSuite(numThreads: Int) {
  reusableClient = getClient(numThreads = numThreads)

  statusCode(10, numThreads)
  System.gc()
  println("===================")
  ...
  mediumResponse(10, numThreads)
  System.gc()
  println("===================")

  mediumResponse(100, numThreads)
  System.gc()
  println("===================")

  mediumResponse(1000, numThreads)
  System.gc()
  println("===================")

  mediumResponse(10_000, numThreads)
  System.gc()
  println("===================")
}
